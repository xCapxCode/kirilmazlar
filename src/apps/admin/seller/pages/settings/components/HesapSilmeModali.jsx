...
const HesapSilmeModali = ({ account, onClose, onDelete }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (confirmText !== account.username) {
      showError('Kullanıcı adını doğru girmelisiniz');
      return;
    }
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg max-w-md w-full overflow-hidden">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            <h2 className="text-xl font-semibold text-gray-900">Hesap Sil</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="space-y-4">
            <div className="bg-red-50 border border-red-200 rounded-md p-4">
              <div className="flex items-start space-x-2">
                ...
                <div className="text-sm text-red-700">
                  ...
                  <p>Bu hesabı silmek istediğinizden emin misiniz? Bu işlem geri alınamaz ve hesaba ait tüm veriler silinecektir.</p>
                </div>
              </div>
            </div>
            ...
            <div>
              <label htmlFor="confirmText" className="block text-sm font-medium text-gray-700 mb-1">
                Onaylamak için "{account.username}" yazın
              </label>
              <input
                id="confirmText"
                type="text"
          ...
          <div className="mt-6 flex justify-end space-x-3">
            ...
            <button
              type="submit"
              disabled={isSubmitting || confirmText !== account.username}
...
export default HesapSilmeModali;
