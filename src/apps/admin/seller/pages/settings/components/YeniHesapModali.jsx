...
const YeniHesapModali = ({ onClose, onSave }) => {
      ...
      <div className="bg-white rounded-lg max-w-md w-full overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="mt-6 flex justify-end space-x-3">
            ...
            <button
              type="submit"
              disabled={isSubmitting || !formData.username || !formData.password || formData.password !== formData.confirmPassword}
...
export default YeniHesapModali;
