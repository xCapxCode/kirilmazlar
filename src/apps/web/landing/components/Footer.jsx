...
import { CookiePolicyContent, PrivacyPolicyContent, TermsOfServiceContent } from './PolicyContent';
  ...
  return (
    <>
      <footer id="footer" className="relative text-white w-full overflow-hidden min-h-[500px]">
        ...
        {/* İçerik */}
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 h-full flex flex-col justify-center">
          {/* Üst Kısım */}
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-70 z-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-8 py-4 flex flex-col md:flex-row justify-between items-center text-xs text-gray-400 relative z-30">
